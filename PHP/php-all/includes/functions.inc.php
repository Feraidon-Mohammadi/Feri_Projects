...
<footer class="bg-dark bg-gradient text-white py-5">
    <div class="<?php echo $class_fluid; ?> ">
        <p><marquee bgcolor="#123456" Font-color="#33ddff">&copy;<?php echo date('Y') ?> Feraidon Mohammadi kurs : php</marquee></p>
</div>
</footer>
<?php if( $bootstrap_js ): ?>
...
function errorHandler(int $errno, string $errstr, string $errfile = null, int $errline = null): bool
{
 ...
 #fehler prüfe und stattdessen prüf funtionen selbst geschriebene kommentar
/** 
 *
 *is_logged_in()
 *prüft anhand des Session-Array,ob ein Benutzer eingeloggt ist.
 *
...
/**
    ...
    * @return string Das neue formatierte Datum 
    */

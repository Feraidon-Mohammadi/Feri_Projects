...
-- where bundesland = ('beyern' ,'baden-Würtenberg');
order by plz;
...
join rechnung
on rechngpos.rechnungnr =rechnung.rechnungnr
where YEAR(rechnung.rechnungdatum) = 1997
and MONTH(rechnung.rechnungdatum) = 1
and rechnung.discount =  0;

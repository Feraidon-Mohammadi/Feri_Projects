...
app.config["SECRET_KEY"] = hashed_password #"5e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8" # result von password
app.config["JWT_SECRET_KEY"] = jwt_password
jwt = JWTManager(app)

# {
#     "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJmcmVzaCI6ZmFsc2UsImlhdCI6MTcwMjQ2MzY4MCwianRpIjoiZWViMjE2NjEtYzQzYy00MWRmLTk3MDktYjYwNWY0MDQyMDgwIiwidHlwZSI6ImFjY2VzcyIsInN1YiI6ImZlcmkiLCJuYmYiOjE3MDI0NjM2ODAsImV4cCI6MTcwMjQ2NDU4MH0.Q4yU55c8uojn8qYg2SoxAMHpnPLMW7Ut1FZl_X86qK8"
# }
...
class DozentAPI(Resource):
    ...
    # @jwt_required()
    # @api.doc(model=dozent_model)
    # @api.marshal_with(dozent_model)
    # def get(self):
    #     #print(request.headers)
    #     return Dozent.query.all()
...
#         'swagger_ui_init_js': '/static/your-custom-init.js',
#         'swagger_ui_standalone_presets': [

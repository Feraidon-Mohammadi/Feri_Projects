...
input_pdf_path = 'input_pdf/jalil.pdf'  # Specify the input PDF file
output_pdf_path = 'output_pdf/jalil.pdf'  # Specify the output PDF file
pages_to_remove = [2]  # Specify the page numbers to remove

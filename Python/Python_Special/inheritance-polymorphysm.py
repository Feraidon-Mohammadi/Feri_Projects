...
# class called Vehicle and make Car, Boat, Plane child classes of Vehicle:
"""
What about classes with child classes with the same name? Can we use polymorphism there?Yes. 

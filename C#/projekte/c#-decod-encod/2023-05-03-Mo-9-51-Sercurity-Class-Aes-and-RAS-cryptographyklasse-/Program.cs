...
/*
 ...
 Um Daten in C# mit AES oder RSA zu verschlüsseln und zu entschlüsseln, gibt es verschiedene Bibliotheken und Methoden.

Hier sind einige Schritte,um dies zu erreichen: Fügen Sie das System.Security.Cryptography-Namespace zu Ihrer Anwendung hinzu.
    ...
    class Program
    {
       // private static string decrypted;
        ...
        static void Main(string[] args)
        {
            ...
            string text = "Hello World!"; // The text to encrypt
        }
